...
class Config:
    ...
    BOT_TOKEN = environ.get("BOT_TOKEN", "7550570083:AAF73q5WQOtZeFB1zwi3K2LxAJn8bsjvcPE") 
    ...
    BOT_OWNER = int(environ.get("BOT_OWNER", "5787359348 1980293755 7393277081 7327360759"))
